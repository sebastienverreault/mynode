...
$TORIFY apt-get -y install hexyl python-apt libglib2.0-dev libcairo2-dev libgirepository1.0-dev libxml2-dev
$TORIFY apt-get -y install libxslt-dev libcurl4-openssl-dev
